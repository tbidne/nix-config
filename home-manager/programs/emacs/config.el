...
(setq user-full-name "Thomas Bidne"
      user-mail-address "tbidne@protonmail.com")
...
(setq doom-font (font-spec  :family "Hasklig" :size 40))
...
;; Makes whitespace visible in whitespace mode.
;; TODO: make this like vs code e.g.
;; 1. only display spaces if num > 1
